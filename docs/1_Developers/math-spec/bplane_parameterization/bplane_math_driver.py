...
if __name__ == "__main__":
    ...
    # print('d_trueAnomaly_d_r difference = \n', d_trueAnomaly_d_r_ad - d_trueAnomaly_d_x[0:3])
    # print('d_trueAnomaly_d_v difference = \n', d_trueAnomaly_d_v_ad - d_trueAnomaly_d_x[3:6])
    ...
    # print('')
    # print('d_eCrossR_d_r_ad = \n', d_eCrossR_d_r_ad - d_eCrossR_d_x[0:3,0:3])
    # print('d_eCrossR_d_v_ad = \n', d_eCrossR_d_v_ad - d_eCrossR_d_x[0:3,3:6])
    # print('d_eCrossR_d_r_ad = \n', d_eCrossR_d_r_ad)
    # print('d_eCrossR_d_v_ad = \n', d_eCrossR_d_v_ad)
    ...
    #print('d_bDotT_d_v = \n', d_BdotT_d_x[3:6])
    #print('')
    #print('d_bTheta_d_r_ad = \n', d_bTheta_d_r_ad - d_bTheta_dx[0:3])
    #print('d_bTheta_d_v_ad = \n', d_bTheta_d_v_ad - d_bTheta_dx[3:6])
    #print('d_bTheta_d_r = \n', d_bTheta_dx[0:3])
    #print('d_bTheta_d_v = \n', d_bTheta_dx[3:6])
    #print('')
    #print('d_rPeri_d_r_ad = \n', d_rPeri_d_r_ad - d_rPeri_d_x[0:3])
    #print('d_rPeri_d_v_ad = \n', d_rPeri_d_v_ad - d_rPeri_d_x[3:6])
    #print('d_rPeri_d_r = \n', d_rPeri_d_x[0:3])
    #print('d_rPeri_d_v = \n', d_rPeri_d_x[3:6])
    #print('')
    #print('d_vInfMag_d_r_ad = \n', d_vInfMag_d_r_ad - d_vInfMag_d_x[0:3])
    #print('d_vInfMag_d_v_ad = \n', d_vInfMag_d_v_ad - d_vInfMag_d_x[3:6])
    #print('d_vInfMag_d_r = \n', d_vInfMag_d_x[0:3])
    #print('d_vInfMag_d_v = \n', d_vInfMag_d_x[3:6])
    #print('')
    #print('d_vInfRA_d_r_ad = \n', d_vInfRA_d_r_ad - d_vInfRA_d_x[0:3])
    #print('d_vInfRA_d_v_ad = \n', d_vInfRA_d_v_ad - d_vInfRA_d_x[3:6])
    #print('d_vInfRA_d_r = \n', d_vInfRA_d_x[0:3])
    #print('d_vInfRA_d_v = \n', d_vInfRA_d_x[3:6])
    #print('')
    #print('d_vInfDec_d_r_ad = \n', d_vInfDec_d_r_ad - d_vInfDec_d_x[0:3])
    #print('d_vInfDec_d_v_ad = \n', d_vInfDec_d_v_ad - d_vInfDec_d_x[3:6])
    #print('d_vInfDec_d_r = \n', d_vInfDec_d_x[0:3])
    #print('d_vInfDec_d_v = \n', d_vInfDec_d_x[3:6])
