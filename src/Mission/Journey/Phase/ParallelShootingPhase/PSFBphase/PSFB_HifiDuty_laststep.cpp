...
namespace EMTG
{
    namespace Phases
    {
        PSFB_HifiDuty_laststep::PSFB_HifiDuty_laststep() {};

        PSFB_HifiDuty_laststep::PSFB_HifiDuty_laststep(const std::string& name,
        ...
        void PSFB_HifiDuty_laststep::initialize(const std::string& name,
            const size_t& journeyIndex,
            const size_t& phaseIndex,
            const size_t& stepIndex,
            const size_t& stageIndex,
            ...
            missionoptions* myOptions)
        {
         ...
         //master calcbounds
        void PSFB_HifiDuty_laststep::calcbounds_step()
        {
         ...
         //master process
        void PSFB_HifiDuty_laststep::process_step(const std::vector<doubleType>& X,
            size_t& Xindex,
