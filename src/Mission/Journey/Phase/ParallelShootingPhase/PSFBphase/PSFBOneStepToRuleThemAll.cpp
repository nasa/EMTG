...
namespace EMTG
{
    namespace Phases
    {
        PSFBOneStepToRuleThemAll::PSFBOneStepToRuleThemAll() {};

        PSFBOneStepToRuleThemAll::PSFBOneStepToRuleThemAll(const std::string& name,
        ...
        void PSFBOneStepToRuleThemAll::initialize(const std::string& name,
            const size_t& journeyIndex,
            const size_t& phaseIndex,
            const size_t& stepIndex,
            const size_t& stageIndex,
            ...
            missionoptions* myOptions)
        {
         ...
         //master calcbounds
        void PSFBOneStepToRuleThemAll::calcbounds_step()
        {
         ...
         //master process
        void PSFBOneStepToRuleThemAll::process_step(const std::vector<doubleType>& X,
            size_t& Xindex,
