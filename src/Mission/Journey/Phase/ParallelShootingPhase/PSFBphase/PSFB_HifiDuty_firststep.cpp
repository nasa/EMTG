...
namespace EMTG
{
    namespace Phases
    {
        PSFB_HifiDuty_firststep::PSFB_HifiDuty_firststep() {};

        PSFB_HifiDuty_firststep::PSFB_HifiDuty_firststep(const std::string& name,
        ...
        void PSFB_HifiDuty_firststep::initialize(const std::string& name,
            const size_t& journeyIndex,
            const size_t& phaseIndex,
            const size_t& stepIndex,
            const size_t& stageIndex,
            ...
            missionoptions* myOptions)
        {
         ...
         //master calcbounds
        void PSFB_HifiDuty_firststep::calcbounds_step()
        {
         ...
         //master process
        void PSFB_HifiDuty_firststep::process_step(const std::vector<doubleType>& X,
            size_t& Xindex,
