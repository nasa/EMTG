...
namespace EMTG
{
    namespace Phases
    {
        PSFB_HifiDuty_OneStepToRuleThemAll::PSFB_HifiDuty_OneStepToRuleThemAll() {};

        PSFB_HifiDuty_OneStepToRuleThemAll::PSFB_HifiDuty_OneStepToRuleThemAll(const std::string& name,
        ...
        void PSFB_HifiDuty_OneStepToRuleThemAll::initialize(const std::string& name,
            const size_t& journeyIndex,
            const size_t& phaseIndex,
            const size_t& stepIndex,
            const size_t& stageIndex,
            ...
            missionoptions* myOptions)
        {
            this->PSFB_HifiDuty_step::initialize(name,
                journeyIndex,
                phaseIndex,
                stepIndex,
                stageIndex,
         ...
         //master calcbounds
        void PSFB_HifiDuty_OneStepToRuleThemAll::calcbounds_step()
        {
         ...
         //master process
        void PSFB_HifiDuty_OneStepToRuleThemAll::process_step(const std::vector<doubleType>& X,
            size_t& Xindex,
