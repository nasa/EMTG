...
namespace EMTG
{
    namespace Phases
    {
        class PSBIOneStepToRuleThemAll : virtual public PSBIstep, virtual public ParallelShootingOneStepToRuleThemAll
        {
        public:
            //constructor
            PSBIOneStepToRuleThemAll();
            PSBIOneStepToRuleThemAll(const std::string& name,
            ...
            //clone
            virtual PSBIOneStepToRuleThemAll* clone() const { return new PSBIOneStepToRuleThemAll(*this); }

            //destructor
            virtual ~PSBIOneStepToRuleThemAll() {};
