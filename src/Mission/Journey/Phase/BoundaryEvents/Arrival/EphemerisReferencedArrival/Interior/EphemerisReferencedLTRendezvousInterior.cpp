...
#include "EphemerisReferencedLTRendezvousInterior.h"

namespace EMTG
{
    namespace BoundaryEvents
    {
        EphemerisReferencedLTRendezvousInterior::EphemerisReferencedLTRendezvousInterior(const std::string& name,
            ...
            EphemerisReferencedArrivalInterior::EphemerisReferencedArrivalInterior(name,
                    journeyIndex,
                    phaseIndex,
                    stageIndex,
                    Universe,
        ...
        void EphemerisReferencedLTRendezvousInterior::calcbounds_event_right_side()
        {
            //base class
        ...
        void EphemerisReferencedLTRendezvousInterior::process_event(const std::vector<doubleType>& X,
            size_t& Xindex,
        ...
        void EphemerisReferencedLTRendezvousInterior::process_event_interface_state(const std::vector<doubleType>& X,
            size_t& Xindex,
            std::vector<doubleType>& F,
            size_t& Findex,
            std::vector<double>& G,
        ...
        void EphemerisReferencedLTRendezvousInterior::process_event_right_side(const std::vector<doubleType>& X,
...

        {
            ...
            this->EphemerisReferencedArrivalInterior::process_event_right_side(X, Xindex, F, Findex, G, needG);
        ...
        //******************************************output methods
        void EphemerisReferencedLTRendezvousInterior::output(std::ofstream& outputfile,
