...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedArrivalInterior : virtual public EphemerisReferencedArrival
        {
        public:
            //default constructor
            EphemerisReferencedArrivalInterior() : ArrivalEvent::ArrivalEvent() {};

            //specialized constructor
            EphemerisReferencedArrivalInterior(const std::string& name,
