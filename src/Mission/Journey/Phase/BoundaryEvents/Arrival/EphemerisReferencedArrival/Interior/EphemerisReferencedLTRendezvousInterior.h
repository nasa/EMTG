...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedLTRendezvousInterior : virtual public EphemerisReferencedArrivalInterior
        {
        public:
            //specialized constructor
            EphemerisReferencedLTRendezvousInterior(const std::string& name,
