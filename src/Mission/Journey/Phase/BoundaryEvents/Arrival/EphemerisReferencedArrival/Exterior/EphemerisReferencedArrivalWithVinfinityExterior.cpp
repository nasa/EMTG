...
#include "EphemerisReferencedArrivalWithVinfinityExterior.h"

namespace EMTG
{
    namespace BoundaryEvents
    {
        EphemerisReferencedArrivalWithVinfinityExterior::EphemerisReferencedArrivalWithVinfinityExterior(const std::string& name,
        ...
        void EphemerisReferencedArrivalWithVinfinityExterior::calcbounds_event_interface_state(const std::vector<double>& vinf_max,
        ...
        void EphemerisReferencedArrivalWithVinfinityExterior::calcbounds_event_right_side()
        {
            //base class
        ...
        void EphemerisReferencedArrivalWithVinfinityExterior::process_event_interface_state(const std::vector<doubleType>& X,
            size_t& Xindex,
