...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        //calcbounds
        void FreePointChemRendezvous::calcbounds(std::vector<size_t> timeVariables)
        {
        ...
        void FreePointChemRendezvous::output_maneuver_and_target_spec(std::ofstream& maneuver_spec_file, std::ofstream& target_spec_file, bool& haveManeuverNeedTarget)
        {
