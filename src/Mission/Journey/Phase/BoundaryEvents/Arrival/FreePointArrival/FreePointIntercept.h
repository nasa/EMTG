...
namespace EMTG
{
    ...
    {
        class FreePointIntercept : public FreePointArrivalWithVinfinity
        {
        public:
            //specialized constructor
            FreePointIntercept(const std::string& name,
        ...
        private:
            void calcbounds_virtual_propellant_constraints(); //TCMs
