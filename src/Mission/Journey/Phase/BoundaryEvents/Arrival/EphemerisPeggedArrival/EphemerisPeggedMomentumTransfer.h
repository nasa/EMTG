...
namespace EMTG
{
    ...
    {
        class EphemerisPeggedMomentumTransfer : public EphemerisPeggedIntercept
        {
        public:
            //specialized constructor
            EphemerisPeggedMomentumTransfer(const std::string& name,
        ...
        private:
            ...
            //fields
			double ddeltav_dVinfinity_in;
            std::vector<size_t> dIndex_ddeltaV_dSpacecraftMass;
            math::Matrix<double> ddeltaV_dSpacecraftMass;
