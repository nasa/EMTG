...
namespace EMTG
{
    ...
    {
        class EphemerisPeggedDeparture : virtual public DepartureEvent,
            virtual public EphemerisPeggedBoundary
        {
        public:
            //default constructor
            EphemerisPeggedDeparture() : DepartureEvent::DepartureEvent() {};

            //specialized constructor
            EphemerisPeggedDeparture(const std::string& name,
            ...
            //this one just makes the base class initialize() happy, avoids final overrider problem
