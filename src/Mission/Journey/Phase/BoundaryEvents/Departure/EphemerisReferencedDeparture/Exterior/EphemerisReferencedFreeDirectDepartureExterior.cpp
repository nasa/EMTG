...
#include "EphemerisReferencedFreeDirectDepartureExterior.h"

namespace EMTG
{
    namespace BoundaryEvents
    {
        EphemerisReferencedFreeDirectDepartureExterior::EphemerisReferencedFreeDirectDepartureExterior(const std::string& name,
            ...
            EphemerisReferencedDepartureExterior::EphemerisReferencedDepartureExterior(name,
                    journeyIndex,
                    phaseIndex,
                    stageIndex,
                    Universe,
        ...
        void EphemerisReferencedFreeDirectDepartureExterior::calcbounds_event_right_side()
        {
            //base class
            this->EphemerisReferencedDepartureExterior::calcbounds_event_right_side();
        ...
        void EphemerisReferencedFreeDirectDepartureExterior::process_event(const std::vector<doubleType>& X,
            size_t& Xindex,
        ...
        void EphemerisReferencedFreeDirectDepartureExterior::process_event_interface_state(const std::vector<doubleType>& X,
            size_t& Xindex,
            std::vector<doubleType>& F,
            size_t& Findex,
            std::vector<double>& G,
            const bool& needG)
        {
            ...
            this->EphemerisReferencedDepartureExterior::process_event_interface_state(X, Xindex, F, Findex, G, needG);
        }//end process_event_interface_state()

        void EphemerisReferencedFreeDirectDepartureExterior::process_event_right_side(const std::vector<doubleType>& X,
            size_t& Xindex,
            std::vector<doubleType>& F,
            size_t& Findex,
            std::vector<double>& G,
        ...
        {
            //base class
            this->EphemerisReferencedDepartureExterior::process_event_right_side(X, Xindex, F, Findex, G, needG);

            std::get<2>(this->Derivatives_of_StateAfterEvent[this->dIndex_mass_wrt_encodedMass]) = this->ETM(6, 6);
        }//end process_event_right_side()

        //******************************************output methods
        void EphemerisReferencedFreeDirectDepartureExterior::output(std::ofstream& outputfile,
