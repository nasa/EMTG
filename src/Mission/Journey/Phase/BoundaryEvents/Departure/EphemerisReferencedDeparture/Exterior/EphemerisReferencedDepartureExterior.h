...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedDepartureExterior : virtual public EphemerisReferencedDeparture
        {
        public:
            //default constructor
            EphemerisReferencedDepartureExterior() : DepartureEvent::DepartureEvent() {};

            //specialized constructor
            EphemerisReferencedDepartureExterior(const std::string& name,
            ...
            //destructor
            virtual ~EphemerisReferencedDepartureExterior() {};
