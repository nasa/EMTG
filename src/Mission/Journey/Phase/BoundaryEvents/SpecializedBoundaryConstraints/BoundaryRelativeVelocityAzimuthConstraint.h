...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryRelativeVelocityAzimuthConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryRelativeVelocityAzimuthConstraint() {};

                BoundaryRelativeVelocityAzimuthConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryRelativeVelocityAzimuthConstraint() {};
            ...
            protected:
                //fields
                doubleType RelativeVelocityAzimuth;
