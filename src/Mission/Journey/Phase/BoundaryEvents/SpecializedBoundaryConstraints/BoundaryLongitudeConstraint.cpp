...
namespace EMTG
{
    namespace BoundaryEvents
    {
        namespace SpecializedConstraints
        {
            ...
            BoundaryLongitudeConstraint::BoundaryLongitudeConstraint(const std::string& name,
            ...
            void BoundaryLongitudeConstraint::process_constraint(const std::vector<doubleType>& X,
                size_t& Xindex,
            ...
            void BoundaryLongitudeConstraint::output(std::ofstream& outputfile)
            {
