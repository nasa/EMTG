...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryBCFlatitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryBCFlatitudeConstraint() {};

                BoundaryBCFlatitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryBCFlatitudeConstraint() {};
