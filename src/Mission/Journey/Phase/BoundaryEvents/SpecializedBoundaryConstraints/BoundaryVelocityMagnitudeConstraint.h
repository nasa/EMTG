...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryVelocityMagnitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryVelocityMagnitudeConstraint() {};

                BoundaryVelocityMagnitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryVelocityMagnitudeConstraint() {};
