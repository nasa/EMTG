...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryDeticLatitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryDeticLatitudeConstraint() {};

                BoundaryDeticLatitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryDeticLatitudeConstraint() {};
