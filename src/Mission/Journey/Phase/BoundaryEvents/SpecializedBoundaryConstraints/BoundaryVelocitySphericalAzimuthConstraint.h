...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryVelocitySphericalAzimuthConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryVelocitySphericalAzimuthConstraint() {};

                BoundaryVelocitySphericalAzimuthConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryVelocitySphericalAzimuthConstraint() {};
            ...
            protected:
                //fields
                doubleType VelocitySphericalAzimuth;
