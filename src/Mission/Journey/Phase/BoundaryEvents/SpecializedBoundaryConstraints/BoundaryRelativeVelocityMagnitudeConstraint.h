...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryRelativeVelocityMagnitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryRelativeVelocityMagnitudeConstraint() {};

                BoundaryRelativeVelocityMagnitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryRelativeVelocityMagnitudeConstraint() {};
            ...
            protected:
                //fields
                doubleType RelativeVelocityMagnitude;
