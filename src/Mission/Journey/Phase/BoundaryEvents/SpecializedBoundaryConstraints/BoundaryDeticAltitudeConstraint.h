...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryDeticAltitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryDeticAltitudeConstraint() {};

                BoundaryDeticAltitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryDeticAltitudeConstraint() {};
