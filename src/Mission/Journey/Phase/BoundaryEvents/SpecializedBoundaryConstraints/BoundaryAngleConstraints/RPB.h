...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class RPBconstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                RPBconstraint() {};

                RPBconstraint(const std::string& name,
            ...
            protected:
                ...
                math::Matrix<double> dcosRPB_dR_body_reference;
                math::Matrix<double> dcosRPB_dV_body_probe;
