...
//backward MGAnDSMs maneuver absolute epoch constraint
//9-26-2017
...
namespace EMTG
{
    namespace Phases
    {
        MGAnDSMs_backward_maneuver_epoch_constraint_absolute::MGAnDSMs_backward_maneuver_epoch_constraint_absolute(const std::string& name,
        ...
        //************************************calcbounds methods
        void MGAnDSMs_backward_maneuver_epoch_constraint_absolute::calcbounds()
        {
            ...
            for (size_t entry = 0; entry < Xindex_burnIndex.size() - 1; ++entry) //we don't have a derivative with respect to THIS subphase's burnIndex, because the burn happens before the propagation
            {
                this->create_sparsity_entry(this->Fdescriptions->size() - 1,
        ...
        //******************************************process methods
        void MGAnDSMs_backward_maneuver_epoch_constraint_absolute::process_constraint(const std::vector<doubleType>& X,
            size_t& Xindex,
