    ...
    namespace ObjectiveFunctions
{
        ...
        MaximizeLogeDryMassObjective::MaximizeLogeDryMassObjective(Astrodynamics::universe* Universe,
            ...
            ObjectiveFunctionBase(Universe,
                ...
                myMission)
        {
            this->name = "MaximizeLogeDryMassObjectiveFunction";
        ...
        void MaximizeLogeDryMassObjective::calcbounds()
        {
        ...
        void MaximizeLogeDryMassObjective::process(const std::vector<doubleType>& X,
            size_t& Xindex,
            ...
            const bool& needG)
        {
            ...
            this->ObjectiveValue = -this->ObjectiveScale * -log(DryMass + 1.0) * this->myUniverse->continuity_constraint_scale_factors(6);
            ...
            if (needG)
            {
                ...
                for (size_t dTankIndex = 0; dTankIndex < this->nElectricPropellantTanks; ++dTankIndex)
                {
                    ...
                    G[Gindex] = this->ObjectiveScale * this->X_scale_factors->operator[](Xindex)
                        * -1.0 / (1.0 + DryMass)_GETVALUE * this->myOptions->electric_propellant_margin
                        * this->myUniverse->continuity_constraint_scale_factors(6);
                }
                ...
                for (size_t dTankIndex = 0; dTankIndex < this->nChemicalFuelTanks; ++dTankIndex)
                {
                    ...
                    G[Gindex] = this->ObjectiveScale * this->X_scale_factors->operator[](Xindex)
                        * -1.0 / (1.0 + DryMass)_GETVALUE * this->myOptions->chemical_propellant_margin
                        * this->myUniverse->continuity_constraint_scale_factors(6);
                }
        ...
        void MaximizeLogeDryMassObjective::output(std::ofstream& outputfile)
        {
            outputfile << "Objective function is \"maximize log_e(dry mass)\"" << std::endl;
