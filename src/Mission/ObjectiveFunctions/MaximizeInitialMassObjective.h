...
namespace EMTG
{
    ...
    {
        class MaximizeInitialMassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeInitialMassObjective() {};

            MaximizeInitialMassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeInitialMassObjective() {};
