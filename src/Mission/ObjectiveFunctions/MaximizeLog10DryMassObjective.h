...
namespace EMTG
{
    ...
    {
        class MaximizeLog10DryMassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeLog10DryMassObjective() {};

            MaximizeLog10DryMassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeLog10DryMassObjective() {};
