    ...
    namespace ObjectiveFunctions
{
        ...
        MinimizeInitialMassObjective::MinimizeInitialMassObjective(Astrodynamics::universe* Universe,
            ...
            ObjectiveFunctionBase(Universe,
                ...
                myMission)
        {
            this->name = "MinimizeInitialMassObjectiveFunction";
        ...
        void MinimizeInitialMassObjective::calcbounds()
        {
        ...
        void MinimizeInitialMassObjective::process(const std::vector<doubleType>& X,
            size_t& Xindex,
        ...
        void MinimizeInitialMassObjective::output(std::ofstream& outputfile)
        {
            outputfile << "Objective function is \"minimize initial mass\"" << std::endl;
