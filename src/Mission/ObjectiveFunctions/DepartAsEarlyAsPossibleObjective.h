...
namespace EMTG
{
    ...
    {
        class DepartAsEarlyAsPossibleObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            DepartAsEarlyAsPossibleObjective() {};

            DepartAsEarlyAsPossibleObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~DepartAsEarlyAsPossibleObjective() {};
