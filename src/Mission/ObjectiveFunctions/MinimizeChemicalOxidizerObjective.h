...
namespace EMTG
{
    ...
    {
        class MinimizeChemicalOxidizerObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MinimizeChemicalOxidizerObjective() {};

            MinimizeChemicalOxidizerObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MinimizeChemicalOxidizerObjective() {};
