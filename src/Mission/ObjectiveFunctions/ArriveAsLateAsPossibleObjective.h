...
namespace EMTG
{
    ...
    {
        class ArriveAsLateAsPossibleObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            ArriveAsLateAsPossibleObjective() {};

            ArriveAsLateAsPossibleObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~ArriveAsLateAsPossibleObjective() {};
