...
namespace EMTG
{
    ...
    {
        class MaximizeMassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeMassObjective() {};

            MaximizeMassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeMassObjective() {};
