    ...
    namespace ObjectiveFunctions
{
        ...
        ArriveAsEarlyAsPossibleObjective::ArriveAsEarlyAsPossibleObjective(Astrodynamics::universe* Universe,
        ...
        void ArriveAsEarlyAsPossibleObjective::calcbounds()
        {
        ...
        void ArriveAsEarlyAsPossibleObjective::process(const std::vector<doubleType>& X,
            size_t& Xindex,
        ...
        void ArriveAsEarlyAsPossibleObjective::output(std::ofstream& outputfile)
        {

            outputfile << "Objective function is \"arrive as early as possible\"" << std::endl;
