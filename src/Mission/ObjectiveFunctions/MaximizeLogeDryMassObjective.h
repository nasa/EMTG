...
namespace EMTG
{
    ...
    {
        class MaximizeLogeDryMassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeLogeDryMassObjective() {};

            MaximizeLogeDryMassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeLogeDryMassObjective() {};
