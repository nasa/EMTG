...
namespace EMTG
{
    ...
    {
        class MinimizeTotalPropellantObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MinimizeTotalPropellantObjective() {};

            MinimizeTotalPropellantObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MinimizeTotalPropellantObjective() {};
