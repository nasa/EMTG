...
#ifndef OUTGOING_B_PLANE_RP_TA_STATE_REPRESENTATION_H
#define OUTGOING_B_PLANE_RP_TA_STATE_REPRESENTATION_H
...
namespace EMTG
{
    ...
    {
        class OutgoingBplaneRpTAStateRepresentation : public StateRepresentationBase
        {
        public:
			OutgoingBplaneRpTAStateRepresentation() : OutgoingBplaneRpTAStateRepresentation(1.0) {};
			OutgoingBplaneRpTAStateRepresentation(const double& mu);

            ~OutgoingBplaneRpTAStateRepresentation() {};
...
#endif // OUTGOING_B_PLANE_RP_TA_STATE_REPRESENTATION_H