...
//IncomingBplane state representation
...
namespace EMTG
{
    ...
    {
        IncomingBplaneStateRepresentation::IncomingBplaneStateRepresentation(const double& mu) : StateRepresentationBase::StateRepresentationBase(mu)
        {
            this->name = "IncomingBplane";
            this->stateNames = std::vector<std::string>({ "VINF", "RHA", "DHA", "BRADIUS", "BTHETA", "TA" });
        };

        math::Matrix<doubleType> IncomingBplaneStateRepresentation::convertFromRepresentationToCartesian(const math::Matrix<doubleType>& StateVectorThisRepresentationIn, const bool& needG)
        {
        ...
        math::Matrix<doubleType> IncomingBplaneStateRepresentation::convertFromCartesianToRepresentation(const math::Matrix<doubleType>& StateVectorCartesianIn, const bool& needG)
        {
            //Step 1: set the state vector
