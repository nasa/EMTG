...
#ifndef SPHERICAL_RADEC_STATE_REPRESENTATION_H
#define SPHERICAL_RADEC_STATE_REPRESENTATION_H
...
namespace EMTG
{
    ...
    {
        class SphericalRADECStateRepresentation : public StateRepresentationBase
        {
        public:
            SphericalRADECStateRepresentation(const double& mu);

            ~SphericalRADECStateRepresentation() {};
...
#endif // SPHERICAL_RADEC_STATE_REPRESENTATION_H