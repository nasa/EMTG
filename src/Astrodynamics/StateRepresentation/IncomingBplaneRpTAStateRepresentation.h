...
#ifndef INCOMING_B_PLANE_RP_TA_STATE_REPRESENTATION_H
#define INCOMING_B_PLANE_RP_TA_STATE_REPRESENTATION_H
...
namespace EMTG
{
    ...
    {
        class IncomingBplaneRpTAStateRepresentation : public StateRepresentationBase
        {
        public:
			IncomingBplaneRpTAStateRepresentation() : IncomingBplaneRpTAStateRepresentation(1.0) {};
			IncomingBplaneRpTAStateRepresentation(const double& mu);

            ~IncomingBplaneRpTAStateRepresentation() {};
...
#endif // INCOMING_B_PLANE_RP_TA_STATE_REPRESENTATION_H