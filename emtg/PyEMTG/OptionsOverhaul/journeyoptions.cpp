...
namespace EMTG
{
    ...
    JourneyOptions::JourneyOptions()
    {
        ...
        this->force_unit_magnitude_control = (bool) 0;
        ...
        this->zero_turn_flyby_distance = 1000.0;
        this->terminal_intercept_flyby_distance = 1000.0;
        this->escape_spiral_starting_radius = 6678.0;
        this->escape_spiral_final_radius = 6678.0;
        this->capture_spiral_final_radius = 6678.0;
        this->capture_spiral_starting_radius = 6678.0;
   ...
   void JourneyOptions::parse_line(const std::string& line, size_t& lineNumber, std::ifstream& optionsFileStream)
   {
       ...
       boost::split(linecell, line, boost::is_any_of(" "), boost::token_compress_on);
        ...
        {
            this->force_unit_magnitude_control = (bool) std::stoi(linecell[1]);
            return;
        }
    ...
    void JourneyOptions::write(const std::string& optionsFileName, const bool& newFile, const bool& writeAll)
    {
        ...
        {
            optionsFileStream << "#Force unit magnitude control?" << std::endl;
        ...
        if (this->zero_turn_flyby_distance != 1000.0 || writeAll)
        {
        ...
        if (this->terminal_intercept_flyby_distance != 1000.0 || writeAll)
        {
        ...
        if (this->escape_spiral_starting_radius != 6678.0 || writeAll)
        {
        ...
        if (this->escape_spiral_final_radius != 6678.0 || writeAll)
        {
        ...
        if (this->capture_spiral_final_radius != 6678.0 || writeAll)
        {
            optionsFileStream << "#Final orbit radius for an Edelbaum capture spiral (km)" << std::endl;
            optionsFileStream << "capture_spiral_final_radius " << this->capture_spiral_final_radius << std::endl;
        }
    
        if (this->capture_spiral_starting_radius != 6678.0 || writeAll)
        {
