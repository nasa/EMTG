...
#include "boost/python/extract.hpp"
    ...
    BOOST_PYTHON_MODULE(PyMissionOptions)
    {
        ...
        boost::python::class_<JourneyOptions>("JourneyOptions", boost::python::init<std::string>())
                                          ...
                                          .def_readwrite("force_unit_magnitude_control", &JourneyOptions::force_unit_magnitude_control)
                                          ...
                                          .def_readwrite("escape_spiral_final_radius", &JourneyOptions::escape_spiral_final_radius)
                                          .def_readwrite("capture_spiral_final_radius", &JourneyOptions::capture_spiral_final_radius)
                                          .def_readwrite("capture_spiral_starting_radius", &JourneyOptions::capture_spiral_starting_radius)
        ...
        boost::python::class_<missionoptions>("MissionOptions", boost::python::init<std::string>())
                                          ...
                                          .def_readwrite("power_system_decay_reference_epoch", &missionoptions::power_system_decay_reference_epoch)
                                          ...
                                          .def_readwrite("forward_integrated_ephemeris_central_body_SPICE_ID", &missionoptions::forward_integrated_ephemeris_central_body_SPICE_ID)
                                          ...
                                          .def_readwrite("call_system_to_generate_bsp", &missionoptions::call_system_to_generate_bsp)
                                          .def_readwrite("spice_utilities_path", &missionoptions::spice_utilities_path)
                                          .def_readwrite("spice_utility_extension", &missionoptions::spice_utility_extension)
                                          .def_readwrite("pyemtg_path", &missionoptions::pyemtg_path)
                                          .def_readwrite("spacecraft_SPICE_ID", &missionoptions::spacecraft_SPICE_ID)
