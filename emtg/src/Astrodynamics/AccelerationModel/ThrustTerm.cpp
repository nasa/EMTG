...
namespace EMTG
{
    namespace Astrodynamics
    {
        ...
        void ThrustTerm::computeAccelerationTerm(const bool & generate_derivatives)
        {
            ...
            this->acceleration_model->control_norm = sqrt(u_x * u_x + u_y * u_y + u_z * u_z + epsilon);
            ...
            // A31 dmdotdr
            doubleType u_norm_D_dmdotdP_dPdr = this->acceleration_model->control_norm * (dmdotdP) * (dPdr_sun);
            this->acceleration_model->fx(6, 0) += (-u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(0)) _GETVALUE;
            this->acceleration_model->fx(6, 1) += (-u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(1)) _GETVALUE;
            this->acceleration_model->fx(6, 2) += (-u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(2)) _GETVALUE;
            ...
            // dVirtualChemicalFueldItself
            // 9th row/column...nothing to do here
            
            // dVirtualElectricPropellantdr
            this->acceleration_model->fx(9, 0) += (u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(0)) _GETVALUE;
            this->acceleration_model->fx(9, 1) += (u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(1)) _GETVALUE;
            this->acceleration_model->fx(9, 2) += (u_norm_D_dmdotdP_dPdr * this->acceleration_model->dr_sun2sc_normdr_cb2sc(2)) _GETVALUE;
