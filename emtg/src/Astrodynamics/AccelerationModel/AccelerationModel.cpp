...
namespace EMTG {
    namespace Astrodynamics {
        ...
        AccelerationModel::AccelerationModel(missionoptions * options_in, 
                                             JourneyOptions * journey_options_in, 
                                             universe * universe_in,
                                             std::vector<std::string>* Xdescriptions) :
                                             my_options(options_in),
                                             my_journey_options(journey_options_in),
                                             my_universe(universe_in),
                                             Xdescriptions(Xdescriptions)
        {
