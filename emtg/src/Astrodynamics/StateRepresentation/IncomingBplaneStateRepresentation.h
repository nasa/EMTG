...
#ifndef INCOMING_B_PLANE_STATE_REPRESENTATION_H
#define INCOMING_B_PLANE_STATE_REPRESENTATION_H
...
namespace EMTG
{
    ...
    {
        class IncomingBplaneStateRepresentation : public StateRepresentationBase
        {
        public:
            IncomingBplaneStateRepresentation() : IncomingBplaneStateRepresentation(1.0) {};
            IncomingBplaneStateRepresentation(const double& mu);

            ~IncomingBplaneStateRepresentation() {};
...
#endif // INCOMING_B_PLANE_STATE_REPRESENTATION_H