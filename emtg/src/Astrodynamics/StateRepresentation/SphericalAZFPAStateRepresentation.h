...
#ifndef SPHERICAL_AZFPA_STATE_REPRESENTATION_H
#define SPHERICAL_AZFPA_STATE_REPRESENTATION_H
...
namespace EMTG
{
    ...
    {
        class SphericalAZFPAStateRepresentation : public StateRepresentationBase
        {
        public:
            SphericalAZFPAStateRepresentation(const double& mu);

            ~SphericalAZFPAStateRepresentation() {};
...
#endif // SPHERICAL_AZFPA_STATE_REPRESENTATION_H