...
void ConstructHardware(EMTG::missionoptions & options, EMTG::HardwareModels::LaunchVehicleOptions & myLaunchVehicleOptions, EMTG::HardwareModels::SpacecraftOptions & mySpacecraftOptions)
{
    ...
    {
        //LV from library
        EMTG::HardwareModels::LaunchVehicleOptionsLibrary myLaunchVehicleOptionsLibrary(options.LaunchVehicleLibraryPath);
    ...
    myElectricPropulsionSystemOptions.setNumberOfStrings(options.number_of_engines);
    ...
    myElectricPropulsionSystemOptions.setThrottleTableFile(options.throttle_table);
