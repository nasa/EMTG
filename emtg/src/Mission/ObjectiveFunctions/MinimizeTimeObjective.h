...
namespace EMTG
{
    ...
    {
        class MinimizeTimeObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MinimizeTimeObjective() {};

            MinimizeTimeObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MinimizeTimeObjective() {};
        ...
        protected:
            //fields
            std::vector<size_t> time_variables_Xindices;
