...
namespace EMTG
{
    ...
    {
        class MaximizeLogeMassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeLogeMassObjective() {};

            MaximizeLogeMassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeLogeMassObjective() {};
