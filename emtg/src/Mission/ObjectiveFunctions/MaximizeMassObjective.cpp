    ...
    namespace ObjectiveFunctions
{
        ...
        MaximizeMassObjective::MaximizeMassObjective(Astrodynamics::universe* Universe,
        ...
        void MaximizeMassObjective::calcbounds()
        {
        ...
        void MaximizeMassObjective::process(const std::vector<doubleType>& X,
            size_t& Xindex,
            ...
            const bool& needG)
        {
            ...
            this->ObjectiveValue = -this->ObjectiveScale * FinalState(6) * this->myUniverse->continuity_constraint_scale_factors(6);
        ...
        void MaximizeMassObjective::output(std::ofstream& outputfile)
        {
            outputfile << "Objective function is \"maximize final mass\"" << std::endl;
