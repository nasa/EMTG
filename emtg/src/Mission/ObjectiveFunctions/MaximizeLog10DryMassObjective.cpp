    ...
    namespace ObjectiveFunctions
{
        ...
        MaximizeLog10DryMassObjective::MaximizeLog10DryMassObjective(Astrodynamics::universe* Universe,
            ...
            ObjectiveFunctionBase(Universe,
                ...
                myMission)
        {
            this->name = "MaximizeLog10DryMassObjectiveFunction";
        ...
        void MaximizeLog10DryMassObjective::calcbounds()
        {
        ...
        void MaximizeLog10DryMassObjective::process(const std::vector<doubleType>& X,
            size_t& Xindex,
            ...
            const bool& needG)
        {
            ...
            doubleType DryMass = FinalState(6)
            ...
            this->ObjectiveValue = -this->ObjectiveScale * -log10(DryMass + 1.0) * this->myUniverse->continuity_constraint_scale_factors(6);
            ...
            if (needG)
            {
                ...
                for (size_t dIndex = 0; dIndex < this->number_of_non_time_derivatives; ++dIndex)
                {
                    ...
                    G[Gindex] = this->ObjectiveScale * this->X_scale_factors->operator[](Xindex)
                        * 1.0 / (DryMass + 1.0)_GETVALUE / log(10.0)
                ...
                for (size_t dTankIndex = 0; dTankIndex < this->nElectricPropellantTanks; ++dTankIndex)
                {
                    ...
                    G[Gindex] = this->ObjectiveScale * this->X_scale_factors->operator[](Xindex)
                        * -1.0 / (1.0 + DryMass)_GETVALUE * this->myOptions->electric_propellant_margin / log(10.0)
                        * this->myUniverse->continuity_constraint_scale_factors(6);
                }
                ...
                for (size_t dTankIndex = 0; dTankIndex < this->nChemicalFuelTanks; ++dTankIndex)
                {
                    ...
                    G[Gindex] = this->ObjectiveScale * this->X_scale_factors->operator[](Xindex)
                        * -1.0 / (1.0 + DryMass)_GETVALUE * this->myOptions->chemical_propellant_margin / log(10.0)
                        * this->myUniverse->continuity_constraint_scale_factors(6);
                }
        ...
        void MaximizeLog10DryMassObjective::output(std::ofstream& outputfile)
        {
            outputfile << "Objective function is \"maximize log_10(dry mass)\"" << std::endl;
