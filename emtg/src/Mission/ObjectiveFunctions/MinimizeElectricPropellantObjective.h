...
namespace EMTG
{
    ...
    {
        class MinimizeElectricPropellantobjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MinimizeElectricPropellantobjective() {};

            MinimizeElectricPropellantobjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MinimizeElectricPropellantobjective() {};
