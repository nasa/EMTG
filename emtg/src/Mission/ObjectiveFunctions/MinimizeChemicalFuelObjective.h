...
namespace EMTG
{
    ...
    {
        class MinimizeChemicalFuelObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MinimizeChemicalFuelObjective() {};

            MinimizeChemicalFuelObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MinimizeChemicalFuelObjective() {};
