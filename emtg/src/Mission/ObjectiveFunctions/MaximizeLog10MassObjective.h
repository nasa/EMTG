...
namespace EMTG
{
    ...
    {
        class MaximizeLog10MassObjective : public ObjectiveFunctionBase
        {
        public:
            //constructors
            MaximizeLog10MassObjective() {};

            MaximizeLog10MassObjective(Astrodynamics::universe* Universe,
                HardwareModels::Spacecraft* mySpacecraft,
                missionoptions* myOptions,
                Mission* myMission);

            //destructor
            virtual ~MaximizeLog10MassObjective() {};
