...
namespace EMTG
{
    namespace Phases
    {
        class PSFBOneStepToRuleThemAll : virtual public PSFBstep, virtual public ParallelShootingOneStepToRuleThemAll
        {
        public:
            //constructor
            PSFBOneStepToRuleThemAll();
            PSFBOneStepToRuleThemAll(const std::string& name,
            ...
            //clone
            virtual PSFBOneStepToRuleThemAll* clone() const { return new PSFBOneStepToRuleThemAll(*this); }

            //destructor
            virtual ~PSFBOneStepToRuleThemAll() {};
