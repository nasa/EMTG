...
//backward MGAnDSMs maneuver epoch constraint with respect to left boundary
//9-26-2017
...
namespace EMTG
{
    namespace Phases
    {
        MGAnDSMs_backward_maneuver_epoch_constraint_wrt_left_boundary::MGAnDSMs_backward_maneuver_epoch_constraint_wrt_left_boundary(const std::string& name,
        ...
        //************************************calcbounds methods
        void MGAnDSMs_backward_maneuver_epoch_constraint_wrt_left_boundary::calcbounds()
        {
         ...
         //******************************************process methods
        void MGAnDSMs_backward_maneuver_epoch_constraint_wrt_left_boundary::process_constraint(const std::vector<doubleType>& X,
            size_t& Xindex,
            ...
            const bool& needG)
        {
            ...
            doubleType TimeSinceLeftBoundary = (1.0 - SumOfBurnIndices) * PhaseFlightTime;
            ...
            if (needG)
            {
                ...
                G[Gindex] = this->X_scale_factors->operator[](Xindex)
                    * (1.0 - SumOfBurnIndices) _GETVALUE
                    / 86400.0 / 100.0;
