...
//forward MGAnDSMs maneuver epoch constraint
//9-25-2017
...
namespace EMTG
{
    namespace Phases
    {
        MGAnDSMs_forward_maneuver_epoch_constraint_wrt_right_boundary::MGAnDSMs_forward_maneuver_epoch_constraint_wrt_right_boundary(const std::string& name,
        ...
        //************************************calcbounds methods
        void MGAnDSMs_forward_maneuver_epoch_constraint_wrt_right_boundary::calcbounds()
        {
         ...
         //******************************************process methods
        void MGAnDSMs_forward_maneuver_epoch_constraint_wrt_right_boundary::process_constraint(const std::vector<doubleType>& X,
            size_t& Xindex,
            ...
            const bool& needG)
        {
            ...
            doubleType TimeSinceRightBoundary = (1.0 - SumOfBurnIndices) * PhaseFlightTime;
