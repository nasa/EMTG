...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedDepartureInterior : virtual public EphemerisReferencedDeparture
        {
        public:
            //default constructor
            EphemerisReferencedDepartureInterior() : DepartureEvent::DepartureEvent() {};

            //specialized constructor
            EphemerisReferencedDepartureInterior(const std::string& name,
            ...
            //destructor
            virtual ~EphemerisReferencedDepartureInterior() {};
