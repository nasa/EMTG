...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedFreeDirectDepartureExterior : virtual public EphemerisReferencedDepartureExterior
        {
        public:
            //specialized constructor
            EphemerisReferencedFreeDirectDepartureExterior(const std::string& name,
