...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryRelativeVelocityHFPAConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryRelativeVelocityHFPAConstraint() {};

                BoundaryRelativeVelocityHFPAConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryRelativeVelocityHFPAConstraint() {};
            ...
            protected:
                //fields
                doubleType RelativeVelocityHFPA;
