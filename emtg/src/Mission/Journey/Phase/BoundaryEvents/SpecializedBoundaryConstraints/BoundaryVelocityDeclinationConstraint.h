...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryVelocityDeclinationConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryVelocityDeclinationConstraint() {};

                BoundaryVelocityDeclinationConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryVelocityDeclinationConstraint() {};
