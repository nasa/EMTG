...
#ifndef TARGET_BODY_DETIC_ELEVATION_CONSTRAINT_H
#define TARGET_BODY_DETIC_ELEVATION_CONSTRAINT_H
...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryTargetBodyDeticElevationConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryTargetBodyDeticElevationConstraint() {};

                BoundaryTargetBodyDeticElevationConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryTargetBodyDeticElevationConstraint() {};
            ...
            protected:
                ...
                Astrodynamics::body * target_body;
                std::string target_body_name;

                math::Matrix<doubleType> r_cb2target_ICRF;
                math::Matrix<double>     dr_cb2target_dt_ICRF;
                math::Matrix<doubleType> r_cb2target_constraint_frame;
                math::Matrix<doubleType> r_sc2target_ICRF;
                math::Matrix<doubleType> r_sc2target_constraint_frame;
                math::Matrix<doubleType> surface_normal_vec;

                math::Matrix<doubleType> r_cb2sc_constraint_frame;
...
#endif // TARGET_BODY_DETIC_ELEVATION_CONSTRAINT_H