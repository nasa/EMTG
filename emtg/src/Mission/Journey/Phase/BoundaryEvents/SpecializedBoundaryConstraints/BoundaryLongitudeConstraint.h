...
namespace EMTG
{
    namespace BoundaryEvents
    {
        ...
        namespace SpecializedConstraints
        {
            ...
            class BoundaryLongitudeConstraint : virtual public SpecializedBoundaryConstraintBase
            {
            public:
                //constructors
                BoundaryLongitudeConstraint() {};

                BoundaryLongitudeConstraint(const std::string& name,
                ...
                //destructor
                virtual ~BoundaryLongitudeConstraint() {};
