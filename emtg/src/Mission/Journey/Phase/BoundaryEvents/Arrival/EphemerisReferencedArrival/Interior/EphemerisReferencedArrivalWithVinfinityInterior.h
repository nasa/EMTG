...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedArrivalWithVinfinityInterior : virtual public EphemerisReferencedArrivalInterior
        {
        public:
            //specialized constructor
            EphemerisReferencedArrivalWithVinfinityInterior(const std::string& name,
