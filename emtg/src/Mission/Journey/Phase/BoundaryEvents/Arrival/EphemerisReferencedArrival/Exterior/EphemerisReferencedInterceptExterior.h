...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedInterceptExterior : virtual public EphemerisReferencedArrivalWithVinfinityExterior
        {
        public:
            //specialized constructor
            EphemerisReferencedInterceptExterior(const std::string& name,
