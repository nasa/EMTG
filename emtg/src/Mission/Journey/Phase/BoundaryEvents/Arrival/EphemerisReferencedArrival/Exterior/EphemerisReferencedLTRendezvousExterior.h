...
namespace EMTG
{
    ...
    {
        class EphemerisReferencedLTRendezvousExterior : virtual public EphemerisReferencedArrivalExterior
        {
        public:
            //specialized constructor
            EphemerisReferencedLTRendezvousExterior(const std::string& name,
