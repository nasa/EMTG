...
#include "EphemerisReferencedLTRendezvousExterior.h"

namespace EMTG
{
    namespace BoundaryEvents
    {
        EphemerisReferencedLTRendezvousExterior::EphemerisReferencedLTRendezvousExterior(const std::string& name,
            ...
            EphemerisReferencedArrivalExterior::EphemerisReferencedArrivalExterior(name,
                    journeyIndex,
                    phaseIndex,
                    stageIndex,
                    Universe,
        ...
        //calcbounds
        void EphemerisReferencedLTRendezvousExterior::calcbounds(std::vector<size_t> timeVariables)
        {
            ...
            if (this->isLastEventInJourney
                && this->myOptions->Journeys[this->journeyIndex].timebounded == 2)//bounded arrival date
            {
                EpochBounds[0] = this->myOptions->Journeys[this->journeyIndex].arrival_date_bounds[0];
                EpochBounds[1] = this->myOptions->Journeys[this->journeyIndex].arrival_date_bounds[1];
            }
            else
            {
        ...
        void EphemerisReferencedLTRendezvousExterior::calcbounds_event_interface_state(const std::vector<double>& RAbounds,
        ...
        void EphemerisReferencedLTRendezvousExterior::calcbounds_event_left_side(std::vector<size_t> timeVariables)
        {
            //base class
        ...
        void EphemerisReferencedLTRendezvousExterior::calcbounds_event_right_side()
        {
            //base class
            this->EphemerisReferencedArrivalExterior::calcbounds_event_right_side();
        ...
        void EphemerisReferencedLTRendezvousExterior::process_event(const std::vector<doubleType>& X,
            size_t& Xindex,
        ...
        void EphemerisReferencedLTRendezvousExterior::process_event_interface_state(const std::vector<doubleType>& X,
            size_t& Xindex,
            std::vector<doubleType>& F,
            size_t& Findex,
            std::vector<double>& G,
            const bool& needG)
        {
            ...
            this->EphemerisReferencedArrivalExterior::process_event_interface_state(X, Xindex, F, Findex, G, needG);
        }//end process_event_interface_state()



        void EphemerisReferencedLTRendezvousExterior::process_event_right_side(const std::vector<doubleType>& X,
...

        {
            ...
            this->EphemerisReferencedArrivalExterior::process_event_right_side(X, Xindex, F, Findex, G, needG);
        ...
        //******************************************output methods
        void EphemerisReferencedLTRendezvousExterior::output(std::ofstream& outputfile,
            ...
            size_t& eventcount)
        {
            ...
            else
            {
                ...
                this->myBody->locate_body(this->state_after_event(7),
