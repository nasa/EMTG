...
class PyEMTG_interface(wx.Frame):
    ...
    def initialize_GUI(self):
        ...
        messages = "Welcome to EMTG! \n\nOpen the default mission to get started, from File -> New -> Mission \n\nOr open an existing EMTG options file (.emtgopt) or EMTG output file (.emtg)."

        self.lblWelcome = wx.StaticText(self, -1, messages, style = wx.ALIGN_CENTER) #(self, -1, random.choice(messages), style = wx.ALIGN_CENTER)
        font = self.GetFont()
