...
class BPlaneRpTA2PosVelOut(object):
    ...
    def TAinf(self, x, mu):
        """
        true anomaly of the outgoing asymptote
        """
        eMag = self.eMag(x, mu)
    ...
    def TAinf_derivs(self, x, mu):
        """
        derivatives of true anomaly of the outgoing asymptote
        typed
        """
        eMag = self.eMag(x, mu)
    ...
    def eVector(self, x, mu):
        ...
        e = np.cos(TAinf) * s + np.sin(TAinf) * bUnit
