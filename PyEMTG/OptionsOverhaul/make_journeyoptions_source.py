def make_journeyoptions_source(OptionsDefinitions, now, path = '.'):
    ...
    with open(path + "PyEMTG/OptionsOverhaul/copyright_block.txt", 'r') as file:  # path passed into function = EMTG_path + 'src/Core'
        copyright_block = file.read()

    with open(path + "src/Core/journeyoptions.cpp", "w") as file:
